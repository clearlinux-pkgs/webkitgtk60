...
%setup -q -n webkitgtk-2.46.4
cd %{_builddir}/webkitgtk-2.46.4
pushd ..
cp -a webkitgtk-2.46.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1732725614
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libjavascriptcoregtk-6.0.so.1.3.13
/V3/usr/lib64/libwebkitgtk-6.0.so.4.10.6
/V3/usr/lib64/webkitgtk-6.0/injected-bundle/libwebkitgtkinjectedbundle.so
/usr/lib64/libjavascriptcoregtk-6.0.so.1
/usr/lib64/libjavascriptcoregtk-6.0.so.1.3.13
