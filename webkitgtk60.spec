...
Source0  : https://webkitgtk.org/releases/webkitgtk-2.46.3.tar.xz
Source1  : https://webkitgtk.org/releases/webkitgtk-2.46.3.tar.xz.asc
...
%setup -q -n webkitgtk-2.46.3
cd %{_builddir}/webkitgtk-2.46.3
pushd ..
cp -a webkitgtk-2.46.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730328833
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libjavascriptcoregtk-6.0.so.1.3.12
/V3/usr/lib64/libwebkitgtk-6.0.so.4.10.5
/V3/usr/lib64/webkitgtk-6.0/injected-bundle/libwebkitgtkinjectedbundle.so
/usr/lib64/libjavascriptcoregtk-6.0.so.1
/usr/lib64/libjavascriptcoregtk-6.0.so.1.3.12
/usr/lib64/libwebkitgtk-6.0.so.4
/usr/lib64/libwebkitgtk-6.0.so.4.10.5
