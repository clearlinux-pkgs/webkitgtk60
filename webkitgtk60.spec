...
pushd ..
cp -a webkitgtk-2.46.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726617022
unset LD_AS_NEEDED
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libjavascriptcoregtk-6.0.so.1.3.9
/V3/usr/lib64/libwebkitgtk-6.0.so.4.10.2
